package com.shubham.foodheadquarters.activity
...
import com.shubham.foodheadquarters.R
import com.shubham.foodheadquarters.adapter.CartItemAdapter
import com.shubham.foodheadquarters.adapter.RestaurantMenuAdapter
import com.shubham.foodheadquarters.database.OrderEntity
import com.shubham.foodheadquarters.database.RestaurantDatabase
import com.shubham.foodheadquarters.fragment.RestaurantFragment
import com.shubham.foodheadquarters.model.FoodItem
import com.shubham.foodheadquarters.util.PLACE_ORDER
                ...
                try {
                    ...
                    * Once the DB is cleared, notify the user that the order has been placed*/
                    if (success) {
                        ...
                        * It is just to avoid creating a whole new activity for a very small purpose
                        */
                        val dialog = Dialog(
                            this@CartActivity,
